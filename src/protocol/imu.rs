...
pub const MSGID_QUATERNION_UPDATE: u8 = b'q';
...
pub const MSGID_GYRO_UPDATE: u8 = b'g';
...
pub const MSGID_STREAM_CMD: u8 = b'S';
...
pub const MSG_ID_STREAM_RESPONSE: u8 = b's';
