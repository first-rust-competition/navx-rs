...
pub const NAVX_REG_WHOAMI: u8 = 0x00; /* IMU_MODEL_XXX */
...
/* Read-write */
pub const NAVX_REG_UPDATE_RATE_HZ: u8 = 0x04; /* Range:  4 - 50 [unsigned byte] */
/* Read-only */
...
pub const NAVX_REG_GYRO_FSR_DPS_L: u8 = 0x06; /* Lower 8-bits of Gyro Full-Scale Range */
pub const NAVX_REG_GYRO_FSR_DPS_H: u8 = 0x07; /* Upper 8-bits of Gyro Full-Scale Range */
pub const NAVX_REG_OP_STATUS: u8 = 0x08; /* NAVX_OP_STATUS_XXX */
pub const NAVX_REG_CAL_STATUS: u8 = 0x09; /* NAVX_CAL_STATUS_XXX */
pub const NAVX_REG_SELFTEST_STATUS: u8 = 0x0A; /* NAVX_SELFTEST_STATUS_XXX */
...
pub const NAVX_REG_YAW_L: u8 = 0x16; /* Lower 8 bits of Yaw     */
pub const NAVX_REG_YAW_H: u8 = 0x17; /* Upper 8 bits of Yaw     */
pub const NAVX_REG_ROLL_L: u8 = 0x18; /* Lower 8 bits of Roll    */
pub const NAVX_REG_ROLL_H: u8 = 0x19; /* Upper 8 bits of Roll    */
pub const NAVX_REG_PITCH_L: u8 = 0x1A; /* Lower 8 bits of Pitch   */
pub const NAVX_REG_PITCH_H: u8 = 0x1B; /* Upper 8 bits of Pitch   */
pub const NAVX_REG_HEADING_L: u8 = 0x1C; /* Lower 8 bits of Heading */
pub const NAVX_REG_HEADING_H: u8 = 0x1D; /* Upper 8 bits of Heading */
pub const NAVX_REG_FUSED_HEADING_L: u8 = 0x1E; /* Upper 8 bits of Fused Heading */
pub const NAVX_REG_FUSED_HEADING_H: u8 = 0x1F; /* Upper 8 bits of Fused Heading */
...
pub const NAVX_REG_LINEAR_ACC_X_L: u8 = 0x24; /* Lower 8 bits of Linear Acceleration X */
pub const NAVX_REG_LINEAR_ACC_X_H: u8 = 0x25; /* Upper 8 bits of Linear Acceleration X */
pub const NAVX_REG_LINEAR_ACC_Y_L: u8 = 0x26; /* Lower 8 bits of Linear Acceleration Y */
pub const NAVX_REG_LINEAR_ACC_Y_H: u8 = 0x27; /* Upper 8 bits of Linear Acceleration Y */
pub const NAVX_REG_LINEAR_ACC_Z_L: u8 = 0x28; /* Lower 8 bits of Linear Acceleration Z */
pub const NAVX_REG_LINEAR_ACC_Z_H: u8 = 0x29; /* Upper 8 bits of Linear Acceleration Z */

/* Quaternion:  Range -1 to 1 [signed short ratio] */

pub const NAVX_REG_QUAT_W_L: u8 = 0x2A; /* Lower 8 bits of Quaternion W */
pub const NAVX_REG_QUAT_W_H: u8 = 0x2B; /* Upper 8 bits of Quaternion W */
pub const NAVX_REG_QUAT_X_L: u8 = 0x2C; /* Lower 8 bits of Quaternion X */
pub const NAVX_REG_QUAT_X_H: u8 = 0x2D; /* Upper 8 bits of Quaternion X */
pub const NAVX_REG_QUAT_Y_L: u8 = 0x2E; /* Lower 8 bits of Quaternion Y */
pub const NAVX_REG_QUAT_Y_H: u8 = 0x2F; /* Upper 8 bits of Quaternion Y */
pub const NAVX_REG_QUAT_Z_L: u8 = 0x30; /* Lower 8 bits of Quaternion Z */
pub const NAVX_REG_QUAT_Z_H: u8 = 0x31; /* Upper 8 bits of Quaternion Z */
...
pub const NAVX_REG_MPU_TEMP_C_L: u8 = 0x32; /* Lower 8 bits of Temperature */
pub const NAVX_REG_MPU_TEMP_C_H: u8 = 0x33; /* Upper 8 bits of Temperature */
